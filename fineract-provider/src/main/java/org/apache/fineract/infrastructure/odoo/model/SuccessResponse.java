...
public class SuccessResponse {
    ...
    public SuccessResponse code(Integer code) {
        this.code = code;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.code, successResponse.code) && Objects.equals(this.status, successResponse.status)
     ...
     *            JSON Element
     * @throws IOException
     *             if the JSON Element is invalid with respect to SuccessResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SuccessResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format("The required field(s) %s in SuccessResponse is not found in the empty JSON string",
                                SuccessResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!SuccessResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format("The field `%s` in the JSON string is not defined in the `SuccessResponse` properties. JSON: %s",
        ...
        if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
            SuccessResponseData.validateJsonElement(jsonObj.get("data"));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<SuccessResponse> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(SuccessResponse.class));
     ...
     * @throws IOException
     *             if the JSON string is invalid with respect to SuccessResponse
     */
