...
public class OdooApisAdapter implements OdooApisPort {
     ...
     *                        <tr>
     *                        <td>202</td>
     *                        <td>Request has been successfully logged.</td>
     *                        <td>-</td>
     *                        </tr>
     *                        <tr>
     *                        <td>400</td>
     ...
     *                        <tr>
     *                        <td>500</td>
     *                        <td>Failed to log transaction.</td>
     *                        <td>-</td>
     *                        </tr>
     *                        </table>
     */
     ...
     *                        <tr>
     *                        <td>200</td>
     *                        <td>Successfully retrieved account details.</td>
     *                        <td>-</td>
     *                        </tr>
     *                        </table>
     */
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call odooPostGlAccounts1ValidateBeforeCall(LedgerAccount ledgerAccount, final ApiCallback _callback)
            throws ApiException {
    ...
    public okhttp3.Call odooPostGlAccounts1Async(LedgerAccount ledgerAccount, final ApiCallback<SuccessResponse> _callback)
            throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call odooPostLedger1ValidateBeforeCall(TransactionRequest transactionRequest, final ApiCallback _callback)
            throws ApiException {
    ...
    public okhttp3.Call odooPostLedger1Async(TransactionRequest transactionRequest, final ApiCallback<SuccessResponse> _callback)
            throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call odooPutLedger1ValidateBeforeCall(TransactionRequest transactionRequest, final ApiCallback _callback)
            throws ApiException {
        // verify the required parameter 'transactionRequest' is set
        if (transactionRequest == null) {
    ...
    public okhttp3.Call odooPutLedger1Async(TransactionRequest transactionRequest, final ApiCallback<SuccessResponse> _callback)
            throws ApiException {
