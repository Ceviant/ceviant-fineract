...
public class ErrorResponse {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.code, errorResponse.code) && Objects.equals(this.status, errorResponse.status)
     ...
     *            JSON Element
     * @throws IOException
     *             if the JSON Element is invalid with respect to ErrorResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ErrorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format("The required field(s) %s in ErrorResponse is not found in the empty JSON string",
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!ErrorResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format("The field `%s` in the JSON string is not defined in the `ErrorResponse` properties. JSON: %s",
        ...
        if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
            ErrorResponseData.validateJsonElement(jsonObj.get("data"));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<ErrorResponse> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ErrorResponse.class));
     ...
     * @throws IOException
     *             if the JSON string is invalid with respect to ErrorResponse
     */
