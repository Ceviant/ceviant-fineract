...
public class OdooApisApi {
    ...
    /**
     * Build call for odooGlAccounts1
     *
    ...
    public ApiResponse<List<LedgerAccount>> odooGlAccounts1WithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<LedgerAccount>>() {
        }.getType();
    ...
    /**
     * Build call for odooPostGlAccounts1
     *
    ...
    /**
     * post ledger account (asynchronously)
     *
     * @param ledgerAccount (required)
     * @param _callback     The callback to be executed when the API call finishes
     * @return The request call
