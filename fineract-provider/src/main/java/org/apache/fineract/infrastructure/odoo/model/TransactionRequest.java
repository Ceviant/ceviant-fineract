...
public class TransactionRequest {
    ...
    public TransactionRequest(String branchId, String transactionDate, OffsetDateTime timestamp, String transactionReference,
            String comments, String currencyCode, String dateFormat, List<TransactionEntry> credits, List<TransactionEntry> debits) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.branchId, transactionRequest.branchId)
                ...
                && Objects.equals(this.credits, transactionRequest.credits) && Objects.equals(this.debits, transactionRequest.debits);
    }

    @Override
    public int hashCode() {
        return Objects.hash(branchId, transactionDate, timestamp, transactionReference, comments, currencyCode, dateFormat, credits,
                debits);
    }
     ...
     *            JSON Element
     * @throws IOException
     *             if the JSON Element is invalid with respect to TransactionRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TransactionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format("The required field(s) %s in TransactionRequest is not found in the empty JSON string",
                                TransactionRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!TransactionRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format("The field `%s` in the JSON string is not defined in the `TransactionRequest` properties. JSON: %s",
        ...
        if (!jsonObj.get("branchId").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format("Expected the field `branchId` to be a primitive type in the JSON string but got `%s`",
                            jsonObj.get("branchId").toString()));
        }
        if (!jsonObj.get("transactionReference").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format("Expected the field `transactionReference` to be a primitive type in the JSON string but got `%s`",
                            jsonObj.get("transactionReference").toString()));
        }
        if ((jsonObj.get("comments") != null && !jsonObj.get("comments").isJsonNull()) && !jsonObj.get("comments").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format("Expected the field `comments` to be a primitive type in the JSON string but got `%s`",
                            jsonObj.get("comments").toString()));
        }
        if (!jsonObj.get("currencyCode").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format("Expected the field `currencyCode` to be a primitive type in the JSON string but got `%s`",
        ...
        if ((jsonObj.get("dateFormat") != null && !jsonObj.get("dateFormat").isJsonNull())
            ...
            throw new IllegalArgumentException(
                    String.format("Expected the field `dateFormat` to be a primitive type in the JSON string but got `%s`",
                            jsonObj.get("dateFormat").toString()));
        }
        // ensure the json data is an array
        if (!jsonObj.get("credits").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `credits` to be an array in the JSON string but got `%s`",
                    jsonObj.get("credits").toString()));
        }
        ...
        if (!jsonObj.get("debits").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `debits` to be an array in the JSON string but got `%s`",
                    jsonObj.get("debits").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<TransactionRequest> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(TransactionRequest.class));
     ...
     * @throws IOException
     *             if the JSON string is invalid with respect to TransactionRequest
     */
