...
public class SynchronousCommandProcessingService implements CommandProcessingService {
    ...
    public CommandProcessingResult executeCommand(final CommandWrapper wrapper, final JsonCommand command,
         ...
         * Account. Without this change , it keeps re-using the first command id and system crashes at the third
         * operation because in the new tenant the command is doesn't exists so we need to create a new command for the
         * three operations.
         */
